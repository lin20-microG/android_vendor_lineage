...
$IPTABLES -A 'oem_out' -d 216.200.189.0/24 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 216.200.190.0/24 -j REJECT --reject-with icmp-port-unreachable
...
$IP6TABLES -A 'oem_out' -d 2600:1900::/31 -j REJECT --reject-with icmp6-port-unreachable
$IP6TABLES -A 'oem_out' -d 2600:1904::/30 -j REJECT --reject-with icmp6-port-unreachable
$IP6TABLES -A 'oem_out' -d 2600:1908::/29 -j REJECT --reject-with icmp6-port-unreachable
$IP6TABLES -A 'oem_out' -d 2606:73c0::/32 -j REJECT --reject-with icmp6-port-unreachable
...
$IPTABLES -A 'oem_out' -d 34.0.32.0/19 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 34.0.96.0/19 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 34.0.128.0/18 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 34.0.192.0/19 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 34.0.224.0/22 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 34.0.240.0/20 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 34.1.0.0/19 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 34.3.3.0/24 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 34.4.4.0/24 -j REJECT --reject-with icmp-port-unreachable
...
$IPTABLES -A 'oem_out' -d 35.203.224.0/23 -j REJECT --reject-with icmp-port-unreachable
...
$IPTABLES -A 'oem_out' -d 35.207.0.0/16 -j REJECT --reject-with icmp-port-unreachable
...
$IPTABLES -A 'oem_out' -d 35.219.194.0/24 -j REJECT --reject-with icmp-port-unreachable
$IPTABLES -A 'oem_out' -d 35.219.224.0/19 -j REJECT --reject-with icmp-port-unreachable
...
$IPTABLES -A 'oem_out' -d 66.22.228.0/23 -j REJECT --reject-with icmp-port-unreachable
